export const scenarios = [
  {
    ...
    choices: [
      ...
      },
      {
        ...
        feedback: 'El pirata te recompensa con información valiosa sobre la ruta.',
      },
      {
    ...
    choices: [
      {
        ...
        feedback: '¡Derrota los Marines! Tu recompensa se dispara.',
      },
      {
        text: 'Disfrazarte y pasar desapercibido.',
        trait: 'cunning',
        statRequired: 'stealth',
        statMin: 3,
        bountyBonus: 0,
  ...
  },
  {
    ...
    description:
      'Un pueblo bajo el dominio de un tirano local. La gente pasa hambre mientras el jefe local almacena comida. Te piden ayuda.',
    image: '🏘️',
    choices: [
      {
        ...
        feedback: 'El pueblo te proclama héroe. Los Marines te llaman criminal.',
      },
      {
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        statMin: 4,
        bountyBonus: 3_000_000,
        feedback: '¡Brillante! Llegas antes de lo esperado y con una historia épica.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      {
        text: 'Desafiarlo a un duelo uno a uno. Solo contra solo.',
        trait: 'honorable',
        statRequired: 'strength',
        statMin: 4,
        bountyBonus: 8_000_000,
      ...
      },
      {
        ...
        statMin: 3,
        bountyBonus: 5_000_000,
        feedback: 'Con apoyo, lo superan en número. El rival huye.',
      },
      {
