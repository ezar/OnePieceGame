const BASE_FRUITS = [
  ...
  { id: 'none', name: null, type: null, statBonus: { strength: 0, speed: 0, intelligence: 0, stealth: 0, charisma: 0 }, bountyMultiplier: 1.0 },
];

const DESCRIPTIONS = {
  es: { gomu: 'Te vuelves de goma. Inmune a rayos y golpes contundentes.', hana: 'Puedes brotar partes de tu cuerpo en cualquier superficie.', bara: 'Tu cuerpo puede separarse en piezas e inmune a cortes.', supa: 'Tu cuerpo se convierte en acero cortante.', mera: 'Controlas y te conviertes en fuego.', hie: 'Controlas y te conviertes en hielo.', yomi: 'Te permite revivir una vez tras la muerte.', none: 'Sin poderes de Akuma no Mi. Confías en tu habilidad pura.' },
  en: { gomu: 'Your body becomes rubber. Immune to lightning and blunt attacks.', hana: 'You can sprout body parts on any surface.', bara: 'Your body splits into pieces and is immune to cuts.', supa: 'Your body turns into cutting steel.', mera: 'You control and become fire.', hie: 'You control and become ice.', yomi: 'Allows you to revive once after death.', none: 'No Devil Fruit powers. You rely on pure skill.' },
};
